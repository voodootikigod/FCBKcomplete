...
/*
  ...
  - 2.6.1
  reformatted code to comply with mozilla style guidelines (https://developer.mozilla.org/en/JavaScript_style_guide)
  moved JQuery namespacing to the end of the plugin
  added holder_class and results_class variables for changing css classes
...
;(function($) {
    ...
    $.FCBKCompleter = function(input, options) {
        ...
        function addItem (title, value, preadded) {
            ...
            $(li).click(function() { $(this).toggleClass("deleted"); });
        ...
        function addInput(focusme) {
            ...
            input.keyup(function(event) {
                ...
                if (event.keyCode == KEY.BACKSPACE && etext.length == 0) {
                    feed.hide();
                    browser_msie ? browser_msie_frame.hide() : '';
        ...
        function addMembers(etext, data) {
            ...
            if (data != null && data.length) {
                $.each(data, function(i, val) {
                    ...
                    search_string += "" + (cache.length - 1) + ":" + options.to_search_string(val) + ";";
                });
            }
